<?php //netteCache[01]000429a:2:{s:4:"time";s:21:"0.12075700 1323296566";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:106:"C:\Users\misak113\programing\internet\apache2.2\avantcore\myShark\myShark\templates\Homepage\default.latte";i:2;i:1323296561;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"f38d86f released on 2011-08-24";}}}?><?php

// source file: C:\Users\misak113\programing\internet\apache2.2\avantcore\myShark\myShark\templates\Homepage\default.latte

?><?php list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'fwohc09zx5')
;//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb98c262f96e_content')) { function _lb98c262f96e_content($_l, $_args) { extract($_args)
?>
...
// block _header
//
if (!function_exists($_l->blocks['_header'][] = '_lb7ef8c23185__header')) { function _lb7ef8c23185__header($_l, $_args) { extract($_args); $control->validateControl('header')
...
// block _page
//
if (!function_exists($_l->blocks['_page'][] = '_lbe62a19f706__page')) { function _lbe62a19f706__page($_l, $_args) { extract($_args); $control->validateControl('page')
?>
...
<?php Nette\Latte\Macros\CoreMacros::includeTemplate(''.(\Kate\Main\Loader::MODULES_DIR).S.$content['moduleLabel'].S.'default.latte', get_defined_vars(), $_l->templates['fwohc09zx5'])->render() ;$contentBlock =  'contentModule'.$content['moduleLabel'] ;Nette\Latte\Macros\UIMacros::callBlock($_l, $contentBlock, array('moduleContent' => $content['moduleContent']) + $template->getParams()) ?>
                                                </div>
                                            </div>
                                        </div>
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb6ac09b8514_head')) { function _lb6ac09b8514_head($_l, $_args) { extract($_args)
?>
<style type="text/css">
    #body {
