<?php //netteCache[01]000429a:2:{s:4:"time";s:21:"0.40198400 1329148409";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:106:"C:\Users\misak113\programing\internet\apache2.2\avantcore\myShark\myShark\templates\Homepage\default.latte";i:2;i:1329148335;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"f38d86f released on 2011-08-24";}}}?><?php

// source file: C:\Users\misak113\programing\internet\apache2.2\avantcore\myShark\myShark\templates\Homepage\default.latte

?><?php list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'ghj9ig2gor')
;//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb92a39106cd_content')) { function _lb92a39106cd_content($_l, $_args) { extract($_args)
?>
...
// block _header
//
if (!function_exists($_l->blocks['_header'][] = '_lbabe9f489d2__header')) { function _lbabe9f489d2__header($_l, $_args) { extract($_args); $control->validateControl('header')
...
// block _flashes
//
if (!function_exists($_l->blocks['_flashes'][] = '_lbc5379c4ed2__flashes')) { function _lbc5379c4ed2__flashes($_l, $_args) { extract($_args); $control->validateControl('flashes')
?>
    <div id="flashes">
...
// block _windows
//
if (!function_exists($_l->blocks['_windows'][] = '_lb3eb0930cf3__windows')) { function _lb3eb0930cf3__windows($_l, $_args) { extract($_args); $control->validateControl('windows')
?>
    <div id="windows">
<?php if ($page['loginForm']): Nette\Latte\Macros\CoreMacros::includeTemplate(''.(\Kate\Main\Loader::WINDOWS_DIR).S.'login.latte', get_defined_vars(), $_l->templates['ghj9ig2gor'])->render() ;Nette\Latte\Macros\UIMacros::callBlock($_l, 'loginWindow', array('loginForm' => $page['loginForm']) + $template->getParams()) ;endif ?>
    </div>
<?php
}}
...
// block _page
//
if (!function_exists($_l->blocks['_page'][] = '_lb0de00e04dc__page')) { function _lb0de00e04dc__page($_l, $_args) { extract($_args); $control->validateControl('page')
?>
...
<?php Nette\Latte\Macros\CoreMacros::includeTemplate(''.(\Kate\Main\Loader::MODULES_DIR).S.$content['moduleLabel'].S.'default.latte', get_defined_vars(), $_l->templates['ghj9ig2gor'])->render() ;$contentBlock =  'contentModule'.$content['moduleLabel'] ;Nette\Latte\Macros\UIMacros::callBlock($_l, $contentBlock, array('moduleContent' => $content['moduleContent']) + $template->getParams()) ?>
                                                </div>
                                            </div>
                                        </div>
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb36638384e2_head')) { function _lb36638384e2_head($_l, $_args) { extract($_args)
?>
<style type="text/css">
    #body {
