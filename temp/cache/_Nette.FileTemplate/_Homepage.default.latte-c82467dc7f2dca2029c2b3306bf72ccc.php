<?php //netteCache[01]000429a:2:{s:4:"time";s:21:"0.78545500 1322244780";s:9:"callbacks";a:2:{i:0;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:9:"checkFile";}i:1;s:106:"C:\Users\misak113\programing\internet\apache2.2\avantcore\myShark\myShark\templates\Homepage\default.latte";i:2;i:1322244721;}i:1;a:3:{i:0;a:2:{i:0;s:19:"Nette\Caching\Cache";i:1;s:10:"checkConst";}i:1;s:25:"Nette\Framework::REVISION";i:2;s:30:"f38d86f released on 2011-08-24";}}}?><?php

// source file: C:\Users\misak113\programing\internet\apache2.2\avantcore\myShark\myShark\templates\Homepage\default.latte

?><?php list($_l, $_g) = Nette\Latte\Macros\CoreMacros::initRuntime($template, 'n70n538gzs')
;//
// block content
//
if (!function_exists($_l->blocks['content'][] = '_lb0b3c496c87_content')) { function _lb0b3c496c87_content($_l, $_args) { extract($_args)
?>
...
// block _header
//
if (!function_exists($_l->blocks['_header'][] = '_lbc5aa341809__header')) { function _lbc5aa341809__header($_l, $_args) { extract($_args); $control->validateControl('header')
...
// block _page
//
if (!function_exists($_l->blocks['_page'][] = '_lbdf3fba915e__page')) { function _lbdf3fba915e__page($_l, $_args) { extract($_args); $control->validateControl('page')
?>
...
<?php Nette\Latte\Macros\CoreMacros::includeTemplate(''.(\Kate\Main\Loader::MODULES_DIR).S.$content['moduleLabel'].S.'default.latte', get_defined_vars(), $_l->templates['n70n538gzs'])->render() ;$contentBlock =  'contentModule'.$content['moduleLabel'] ;Nette\Latte\Macros\UIMacros::callBlock($_l, $contentBlock, array('moduleContent' => $content['moduleContent']) + $template->getParams()) ?>
                                                </div>
                                            </div>
                                        </div>
...
// block head
//
if (!function_exists($_l->blocks['head'][] = '_lb0bbc9d16f0_head')) { function _lb0bbc9d16f0_head($_l, $_args) { extract($_args)
?>
<style type="text/css">
    #body {
